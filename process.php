...
<body>
    ...
    <main id="main" class="main" style="margin-top: 130px;">
                            ...
                            <form action="process.php" method="POST" enctype="multipart/form-data" id="formDaftar" class="needs-validation" novalidate>
                              ...
                              <!-- Input Email -->
                               <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" id="inputEmail" name="inputEmail" class="form-control" placeholder="Masukkan Email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Masukkan format email yang valid (ex: xxxx@yyy.zzz)." />
